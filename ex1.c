...
int main()
{
	...
	// por algum motivo notei que nao funciona quando eu puxo a frase do arquivo txt 
	...
	int Tamanho, i, j;
	char frase[500], codigoHuff[600], nomeArq[20];
	...
	//strcpy(frase,"A persistência é o caminho do êxito.");
